        ...
        <div className='bg-gray-50 py-6'>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="flex items-center gap-3 bg-white p-5 rounded-2xl">
                    ...
                    <div className="flex items-center gap-3 bg-white p-5 rounded-2x">
                        <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 bg-white p-5 rounded-2xl">
                        <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center shrink-0">
                            <FaArrowRotateLeft className="text-2xl text-orange-400" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-3 bg-white p-5 rounded-2xl">
                        <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center shrink-0">
                            <FaHeadset className="text-2xl text-violet-600" />
                        </div>
                        <div>
                            <h4 className="font-semibold text-gray-900 text-sm">24/7 Support</h4><p className="text-gray-500 text-xs">Dedicated support team</p>
                        </div>
                    </div>
                </div>
            </div>
